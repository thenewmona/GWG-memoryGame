...
function unflipCards() {
  ...
  setTimeout(() => {
    ...
    console.log(firstCardChildren, secondCardChildren);
  ...
  if (resetGame == true) {
    ...
    if (timeStart === "") {
      timeStart = setInterval(() => {
        //8-30 if i use => timer works, change it per https://www.w3schools.com/js/js_timing.asp it acts like it wants to start but doesnt
        ++timer;
        second = timer % 60;
